...
public class ParallaxEffect : MonoBehaviour
{
    ...
    void Update()
    {
        //during parallax scrolling each layer moves at different speed in order to create the illusion of depth.
        //To that end I’m going to use previously defined parallaxFactor float value.
